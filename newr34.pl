...
% There are 14 ways in the system that something can be a business entity, and
% 17 ways that something can be an executive appointment. The system does not know,
% based on this rule that the business_entity described in executive appointment
% is the same justification for business entity in this rule. We are not interested
% in situations where the executive appointment is in a business entity for one reason
% and the business entity is a business entity for a different reason.
% We could say "executive appointment in a business entity" is a different thing, and
% define it by subtraction instead of multiplication.
...
% THE ABSENCE OF THIS RULE IN THE ORIGINAL IS AN ERROR.
