% This is a version os s34 amended to reflect amendment 1 only.
...
% THIS AMENDMENT MODIFIES THESE DEFEASIBILITY STATEMENTS
...
% Needing to rewrite these in order to amend section 1 is a break of isomorphism.
